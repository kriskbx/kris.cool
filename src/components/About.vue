<template>
    <footer class="footer">
        <Background :align-top="true" :modifiers="['green']" :padding-top="320">
            <Inner :modifiers="['narrow']">
